...
if(appState===1){    
    ...
    if(dataInfoA>10 && dataInfoA<120 && dataInfoB>30 && dataInfoB<80){
    ...
    if(dataInfoA>-10 && dataInfoA<42 && dataInfoB<32 && dataInfoB>5){
    ...
    if(score!=1 && score!=2 && score!=3 && score!=4 && score !=5 && score!=6 && dataInfoA>30 && dataInfoA<120 && dataInfoB>-60 && dataInfoB<60){
        textSize(50);
        text("INDIAN OCEAN",displayWidth/2+150,displayHeight/2+70);
        text("--",displayWidth/2+270,displayHeight/2-10);
    }
    if(score!=1 && score!=2 && score!=3 && score!=4 && score !=5 && score!=6 && dataInfoA>120 && dataInfoA<180 && dataInfoB>-60 && dataInfoB<60){
        textSize(50);
